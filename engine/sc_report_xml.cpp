...
void print_xml_performance( sim_t* sim, xml_writer_t & writer )
{
  ...
  writer.print_tag( "cpu_seconds", util_t::to_string( to_seconds( sim -> elapsed_cpu ), 3 ) );
  writer.print_tag( "speed_up", util_t::to_string( sim -> iterations * sim -> simulation_length.mean / to_seconds( sim -> elapsed_cpu ), 0 ) );
...
void print_xml_summary( sim_t* sim, xml_writer_t & writer )
{
  ...
  writer.print_tag( "elapsed_cpu_sec", util_t::to_string( to_seconds( sim -> elapsed_cpu ) ) );

  writer.begin_tag( "lag" );
  writer.print_attribute( "type", "world" );
  writer.print_attribute( "value", util_t::to_string( to_millis( sim -> world_lag ) ) );
  writer.print_attribute( "stddev", util_t::to_string( to_millis( sim -> world_lag_stddev ) ) );
  writer.end_tag(); // </lag>

  writer.begin_tag( "lag" );
  writer.print_attribute( "type", "queue" );
  writer.print_attribute( "value", util_t::to_string( to_millis( sim -> queue_lag ) ) );
  writer.print_attribute( "stddev", util_t::to_string( to_millis( sim -> queue_lag_stddev ) ) );
  writer.end_tag(); // </lag>
  ...
  if ( sim -> strict_gcd_queue )
  {
    ...
    writer.print_attribute( "value", util_t::to_string( to_millis( sim -> gcd_lag ) ) );
    writer.print_attribute( "stddev", util_t::to_string( to_millis( sim -> gcd_lag_stddev ) ) );
    writer.end_tag(); // </lag>

    writer.begin_tag( "lag" );
    writer.print_attribute( "type", "channel" );
    writer.print_attribute( "value", util_t::to_string( to_millis( sim -> channel_lag ) ) );
    writer.print_attribute( "stddev", util_t::to_string( to_millis( sim -> channel_lag_stddev ) ) );
    writer.end_tag(); // </lag>

    writer.begin_tag( "lag" );
    writer.print_attribute( "type", "queue_gcd" );
    writer.print_attribute( "value", util_t::to_string( to_millis( sim -> queue_gcd_reduction ) ) );
    writer.end_tag(); // </lag>
  }
