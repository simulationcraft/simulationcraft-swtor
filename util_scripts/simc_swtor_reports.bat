...
:runsim
echo.%1%2
call simc.exe %1.simc output=NUL: %3 iterations=%iterations% calculate_scale_factors=%calculate_scale_factors% center_scale_delta=%center_scale_delta% threads=%threads% html=%1%2.html
echo.
goto :eof
